{
    console.log(localStorage.getItem("products_Only"));
}
console.log(localStorage.getItem("products_Only"));
// {
// 
...
// let withoutArray = StringProducts.substring(1, StringProducts.length-1);
// // JSON.parse(withoutArray);
// localStorage.setItem("withoutArray", withoutArray);

// console.log(`all json products ${withoutArray}`);
